...
#include "FYRecorder_mp4convert.h"


#define GONGJIA_TEST
#ifdef GONGJIA_TEST //ANDROID
#include <android/log.h>
#define LOG_TAG 	"MP4Transcode"
...
#ifdef _MINGW32_
#define	fseekto(x,y,z) fseek64(x,y,z)
...
int FYRecorder_do_faststart(char *in, char *out)
{
    FILE *infile  = NULL;
    FILE *outfile = NULL;
